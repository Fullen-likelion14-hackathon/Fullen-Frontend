...
export default function MyPage() {
  ...
  return (
    <div className="min-h-dvh bg-[#faf5f0] pb-32 font-['Pretendard_Variable'] text-[#192940]">
      <header className="border-b-[7px] border-[#aa6829] px-6 pb-5 pt-14 text-center">
        <h1 className="text-[26px] font-bold">마이페이지</h1>
      </header>
      <main className="mx-auto max-w-107 px-8 pt-14">
        <div className="mb-6 flex items-center justify-center gap-2 border-b-2 border-[#e2cdb9] pb-7">
          <p className="text-[25px] font-extrabold text-black">@멋쟁이사자처럼</p>
        ...
        <button
          type="button"
          className="mt-16 flex w-full items-center rounded-2xl bg-[#e5e2e2] px-7 py-5 text-left"
        >

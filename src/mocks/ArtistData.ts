...
export const recommendedArtists: Artist[] = [
  {
    ...
    detailDescription: [
      "빈센트 반 고흐는 네덜란드 출신의 후기 인상주의 화가로, 자신의 내면적 감정과 자연에 대한 인상을 강렬한 색채와 독특한 필치로 표현했다.",

      "그는 대상의 형태를 사실적으로 재현하기보다 형태를 과감하게 단순화하고 왜곡하며, 붓질의 방향과 속도를 통해 화면에 리듬과 운동감을 부여했다.",

      "특히 노랑·파랑·초록 등의 보색에 가까운 색채 대비, 두껍게 물감을 올리는 임파스토 기법, 짧고 반복적인 점·선 형태의 붓터치가 대표적인 특징이다.",

      "《별이 빛나는 밤》에서는 푸른 밤하늘을 굽이치는 곡선과 나선형 붓질로 표현하고, 노란 별과 달을 강렬하게 대비시켜 밤하늘의 역동적인 에너지를 강조했다.",

      "《해바라기》에서는 노랑과 황토 계열의 색조를 중심으로 꽃의 형태와 질감을 거친 붓질로 표현했다.",

      "이처럼 반 고흐의 작품은 색채, 선, 붓질의 방향과 질감 자체를 감정의 언어로 활용한 것이 핵심적인 특징이다.",
    ],
  },
